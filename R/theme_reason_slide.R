#' A [ggplot2] theme formatted in the Reason Foundation style
#'
#' \code{theme_reason} provides a [ggplot2] theme formatted according to the
#' Reason Foundation style guide for presentation slides.
#'
#' @import extrafont
#' @import ggrepel
#' @md
...
theme_reason_slide <- function(base_size = 14.0, base_family = "Calibri",
                             base_line_size = 0.5,
                             base_rect_size = 0.5) {
