...
#'
#' Color palettes used by the Reason Foundation.
#'
#' @export
#' @param palette Palette name.
reason_color_pal <- function(palette = "categorical") {
  palette_list <- palette_reason
...
#' Discrete color scale that aligns with the Reason Foundation style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
scale_color_discrete <- function(...) {
  ggplot2::discrete_scale("colour", "reason", reason_color_pal("categorical"), ...)
}
...
#' Discrete fill scale that aligns with the Reason Foundation style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
scale_fill_discrete <- function(...) {
  ggplot2::discrete_scale("fill", "reason", reason_color_pal("categorical"), ...)
}
...
#' Discrete fill scale for ordinal factors that aligns with the Reason Foundation style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
...
#' Discrete color scale for ordinal factors that aligns with the Reason Foundation style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
